...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mofchecker-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12331&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mofchecker-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mofchecker` can be installed with:

```
conda install mofchecker
```

It is possible to list all of the versions of `mofchecker` available on your platform with:
